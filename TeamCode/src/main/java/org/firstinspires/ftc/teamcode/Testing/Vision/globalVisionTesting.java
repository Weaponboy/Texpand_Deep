...
////        }
//
//        if (!collection.sampleDetector.detections.isEmpty() && collection.sampleDetector.isScanning()){
...
//        }
//
//        if (currentGamepad1.x && !lastGamepad1.x && !collection.sampleDetector.isScanning()){
...
//        }
//        telemetry.addData("collection.sampleSorterContour.isScanning()", collection.sampleDetector.isScanning());
...
//
//            if (!collection.sampleDetector.detections.isEmpty()){
